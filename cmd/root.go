...
// root is a giant switch statement that determines which API call to
// the cloudflare-go library will be made. It will also massage the
// command line flags.
// **What is next for this piece of code:**
// 1. I would like to turn each case in to only a fuction call with
//    the command line args as function arguments.
// 2. Once we have done this, all function calls will be the same
//    (with the hairy argument massaging taking place elsewhere),
//    and this entire function can be autogenerated from the toml
//    configuration file.
